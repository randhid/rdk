...
func TestOrientation(t *testing.T) {
	...
	o, err = ro.ParseConfig()
	test.That(t, err, test.ShouldBeNil)
	test.That(t, o.OrientationVectorDegrees(), test.ShouldResemble, &OrientationVectorDegrees{45, 0, 0, 1, ZAxis})
	...
	o, err = ro.ParseConfig()
	test.That(t, err, test.ShouldBeNil)
	test.That(t, o.OrientationVectorRadians(), test.ShouldResemble, &OrientationVector{0.78539816, 0, 1, 0, ZAxis})
	oc, err = NewOrientationConfig(o)
	test.That(t, err, test.ShouldBeNil)
